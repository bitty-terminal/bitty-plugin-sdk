...
#      bitty-terminal/bitty-plugin-sdk-workflow, override with --url / --mirror),
...
#                  (default: $WORKFLOW_MIRROR_DIR or <repo>/../bitty-plugin-sdk-workflow).
...
MIRROR_DEFAULT="$REPO_ROOT/../bitty-plugin-sdk-workflow"
MIRROR_URL_DEFAULT="https://github.com/bitty-terminal/bitty-plugin-sdk-workflow.git"
